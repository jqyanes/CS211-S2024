...
void accessData (
    ...
    //else (cache not empty)
    	...
    	cache->back->next_cache_line = queue;
    	cache->back = queue;
    	cache->occupancy = (cache->occupancy) + 1;
    }
    /* ... */
